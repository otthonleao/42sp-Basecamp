...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/14 21:30:38 by orodrigo          #+#    #+#             */
/*   Updated: 2021/04/16 13:46:14 by orodrigo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	printf("\n================================== C-03 EX-03 ===================================");
// 	printf("\nConcatenar duas strings, sendo que o s2 será determinado até onde concatenar\n");
// 	printf("=================================================================================\n");
// 	printf("s1: %s\n", s1);
// 	printf("s2: %s\n", s2);
// 	printf("Max de char p/ comparar: %d\n", nb);
// 	printf("s1 + s2 : %s\n", ft_strncat(s1, s2, nb));
// 	printf("Original: %s\n\n", strncat(s3, s4, nb));
